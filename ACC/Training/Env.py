...
class CarlaEnv(gym.Env[VehicleState, Dict[ActionsEnum, float]]):
    ...
    def _reward(self, state : VehicleState) -> tuple[float, Dict]:
        ...
        total_reward = max(min(total_reward, 5.0), -20.0)
